...
<body>
    <div class="frame">
        <div class="card">
        <h4 style = "font-weight: bolder; position: absolute; left: 0; margin-left: 20px; margin-top: 10px;">BUS LOGS</h4>
     ...
     ?>
        ...
        <div class="table-wrapper" style="max-height: 400px; overflow-y: auto;">
            <table class="table align-items-center mb-0" style = "font-size: 12px;">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Logs No.</th>
                  ...
                  <tbody>
                    ...
                    $driver = $_SESSION['id'];
                                ...
                                $sqlfoRAllSchedule = "SELECT * FROM logs ORDER BY id DESC";
                    ...
                    <td>
                      ...
                      <td>
                        <p style = "color: black; font-size: 13px; font-weight: bold;"><?php echo $check['message'] ?></p>
                      </td>
                      <td>
