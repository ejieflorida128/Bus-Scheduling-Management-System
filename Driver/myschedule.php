...
session_start();
     ...
     if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            $message = "New bus named ". $bus . "is looking for Passenger to depart!";
...
<body>
    <div class="frame">
        <div class="card">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalForAddingSchedule" style = "width: 200px; margin: 10px;">
        Add Schedule
        </button>
     ...
     ?>
        ...
        <div class="table-wrapper" style="max-height: 400px; overflow-y: auto;">
            <table class="table align-items-center mb-0" style = "font-size: 12px;">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Schedule No.</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Max Passenger</th>
                  ...
                  <tbody>
                    ...
                    $driver = $_SESSION['id'];
                                ...
                                $sqlfoRAllSchedule = "SELECT * FROM schedules WHERE driver_id = $driver";
                    ...
                    <td>
                      ...
                      <td>
                        <p style = "color: black; font-size: 13px; font-weight: bold;"><?php echo $check['max_passenger'] ?></p>
                      </td>
                      <td>
                      ...
                      <td>
                            <a href="DeleteSchedule.php?id=<?php echo $check['id'] ?>" class = "btn btn-danger">Delete</a>
                      </td>
                    </tr>
